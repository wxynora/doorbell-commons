"""Long-running JSONL adapter for the standalone Monopoly-style engine."""
    ...
    def handle(self, request: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            if operation == "create":
                ...
                if state["game_id"] in self.games:
                    raise CommandError("game_exists", "这局大富翁已经存在。")
                ...
                if game_id not in self.games:
                    raise CommandError("game_not_found", "没有找到这局大富翁。")
                ...
                raise CommandError("unknown_operation", "不支持这个大富翁 worker 操作。")
