"""Long-running JSONL adapter for the standalone UNO engine."""
        ...
        try:
            ...
            if operation == "create":
                ...
                if game_id not in self.games:
                    raise CommandError("game_not_found", "没有找到这局 UNO。")
                ...
                raise CommandError("unknown_operation", "不支持这个 UNO worker 操作。")
