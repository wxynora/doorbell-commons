import { z } from "zod";
import { lingyeDailyCommentSectionKeySchema } from "@doorbell/protocol";
...
export const dailyCommentOperation = {
  ...
  argsSchema: z.strictObject({issueDate:z.iso.date(),section:lingyeDailyCommentSectionKeySchema,text:z.string()}),
