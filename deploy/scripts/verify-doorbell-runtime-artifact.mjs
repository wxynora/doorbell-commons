...
const REQUIRED_PATHS = [
  ...
  "apps/server/src/games/game_incremental.py",
  "games/leaf-game/src/doorbell_leaf_game/engine.py",
  "games/doudizhu/src/doorbell_doudizhu/engine.py",
  "games/flying-chess/src/doorbell_flying_chess/engine.py",
  "games/uno/src/doorbell_uno/engine.py",
  "games/monopoly/src/doorbell_monopoly/engine.py",
  "games/mahjong/src/doorbell_mahjong/engine.py",
  "games/mahjong/third_party/pymahjonggb/setup.py",
  "games/mahjong/THIRD_PARTY_LICENSE",
