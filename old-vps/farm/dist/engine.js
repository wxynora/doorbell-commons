...
function finishRanchRaidHistory(ranch, raid, status, coins) {
...
export function takeRanchNotices(farm) {
...
export function pushRanchNotice(farm, text, now) {
    const ranch = ensureRanch(farm);
