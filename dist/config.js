...
export const HUMAN_HARVEST_DAILY_CAP = 3; // 人类每天最多替自己的 AI 执行 3 次一键收获（UTC+8 零点刷新）
...
// 土地品阶的“运气”加成（roll 时把权重往高稀有抬）。5阶起只扩地，不再提高稀有概率。
export const LAND_LUCK = { 1: 0.15, 2: 0.45, 3: 0.9, 4: 1.5, 5: 1.5, 6: 1.5, 7: 1.5, 8: 1.5, 9: 1.5 };
// —— 浇水运气 ——
...
// 5阶起只增加地块，沿用4阶已满足的图鉴门槛，避免新增作物前出现先有鸡先有蛋死锁。
export const LAND_UPGRADE_REQ = {
    ...
    6: { coins: 200000, commonCodex: 24, fantasyCodex: 10, codexPct: 0 },
    7: { coins: 300000, commonCodex: 24, fantasyCodex: 10, codexPct: 0 },
    8: { coins: 400000, commonCodex: 24, fantasyCodex: 10, codexPct: 0 },
    9: { coins: 500000, commonCodex: 24, fantasyCodex: 10, codexPct: 0 },
};
...
// 仅 /sync/register 与 /sync/:farm 使用；完整存档 + 关联 UGC 允许 2MB，超出直接 413，不截断。
export const SYNC_MAX_BODY_BYTES = 2 * 1024 * 1024;
