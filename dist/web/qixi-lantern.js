...
.qixi-page .btn.qixi-plaque-button{display:flex;align-items:center;justify-content:center;justify-self:center;width:min(100%,var(--qixi-plaque-width));height:var(--qixi-plaque-height);min-height:0;padding:0 28px;border:0;border-radius:0;background:url('${BASE}/assets/qixi-2026/qixi-action-plaque-v1.png?v=2') center/100% 100% no-repeat;color:#ffe4a6;box-shadow:none;text-shadow:0 2px 3px rgba(60,35,83,.78);font:800 var(--qixi-plaque-font)/1.2 var(--serif);letter-spacing:.03em}.qixi-page .btn.qixi-plaque-button:active{transform:translateY(1px);box-shadow:none}
