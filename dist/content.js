...
export const cooking = load("cooking");
export const cookingProducts = cooking.products;
export const cookingIngredients = cooking.ingredients;
export const cookingRecipes = cooking.recipes;
export const fishing = load("fishing");
export const fishingSpots = fishing.spots;
export const fishingFish = fishing.fish;
...
export const cookingProductById = new Map(cookingProducts.map((item) => [item.id, item]));
export const cookingIngredientById = new Map(cookingIngredients.map((item) => [item.id, item]));
export const cookingRecipeById = new Map(cookingRecipes.map((item) => [item.id, item]));
export const fishingSpotById = new Map(fishingSpots.map((item) => [item.id, item]));
export const fishingFishById = new Map(fishingFish.map((item) => [item.id, item]));
